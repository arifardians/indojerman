function prev_item(){
            ...
            var url = base_url+"index.php/front_end/user_exam_controller/prev_soal_lesen";
    ...
    function next_item(){
            ...
            var base_url = $("#base_url").val();
            var url = base_url+"index.php/front_end/user_exam_controller/next_soal_lesen";
            var nomor_soal = parseInt(index_soal);
            var result = $("#result"); 
    ...
    $('#soalForm').submit(function(event){
            ...
            var i = $("#no_soal").val();
            var base_url = $("#base_url").val();
            var url = base_url+"index.php/front_end/user_exam_controller/submit_lesen";
