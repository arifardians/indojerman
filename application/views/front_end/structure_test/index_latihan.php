 ...
 <div class="container min-hight">
    ...
    <div class="row-fluid margin-bottom-30">
        ...
        <div class="span9 blog-item margin-bottom-40">
            <img src="<?php echo base_url();?>assets/img/my_writing.jpg" style="width:80%;">
            <h2><?php echo $title ?></h2>
            <div class="row-fluid">
                <span class="span10">
                    <p><?php echo $content_text; ?></p>
                    <br/><br/>
                    <a href="<?php echo $link;?>" class="btn blue big pull-right"> Lakukan Latihan <span> <i class="fa fa-arrow-circle-right fa-1x"></i> </span>  </a>
                </span>
            </div>
        </div>
        <!-- END BEGIN LEFT BAR -->
