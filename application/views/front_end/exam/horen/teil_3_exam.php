...
<!-- BEGIN CONTAINER -->   
 <div class="container min-hight">
    ...
    <div class="row-fluid margin-bottom-5">
        ...
        <div id="progress_text">Progress | Pertanyaan <span id="current_soal">1</span>  dari <span id="jumlah_soal"><?php echo count($this->session->userdata('horen_exams')); ?></span> </div>
        <div class="progress">
...
<script src="<?php echo base_url();?>assets/scripts/examination/exam_horen_navigation.js" type="text/javascript"></script>
