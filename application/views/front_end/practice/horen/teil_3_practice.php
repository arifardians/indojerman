...
<!-- BEGIN CONTAINER -->   
 <div class="container min-hight">
    ...
    <div class="row-fluid margin-bottom-5">
        ...
        <div id="progress_text">Progress | Pertanyaan <span id="current_soal">1</span>  dari <span id="jumlah_soal"><?php echo count($this->session->userdata('horen_3_soals')); ?></span> </div>
        <div class="progress">
...
<script type="text/javascript">
    function prev_item(){
        ...
        var url = base_url+"index.php/front_end/horenpractice_3_controller/prev_soal";
    ...
    function next_item(){
        ...
        var url = base_url + "index.php/front_end/horenpractice_3_controller/next_soal";
        var nomor_soal = parseInt(index_soal);
        var result = $("#result"); 
    ...
    $('#soalForm').submit(function(event){
        ...
        var i = $("#no_soal").val();
        var base_url = $("#base_url").val();
        var url = base_url + "index.php/front_end/horenpractice_3_controller/submit";
