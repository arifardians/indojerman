...
<script type="text/javascript">
    function prev_item(){
        ...
        var url = base_url+"index.php/front_end/horenpractice_2_controller/prev_soal";
    ...
    function next_item(){
        ...
        var url = base_url + "index.php/front_end/horenpractice_2_controller/next_soal";
        var nomor_soal = parseInt(index_soal);
        var result = $("#result"); 
    ...
    $('#soalForm').submit(function(event){
        ...
        var i = $("#no_soal").val();
        var base_url = $("#base_url").val();
        var url = base_url + "index.php/front_end/horenpractice_2_controller/submit";
