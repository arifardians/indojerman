    ...
    <?php $soals = $this->session->userdata('lesen_1_soals'); ?>
    <?php $images = $this->session->userdata('lesen_1_images'); ?>
    <?php $answers = $this->session->userdata('lesen_1_answers'); ?>
