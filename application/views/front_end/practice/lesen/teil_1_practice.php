...
<!-- BEGIN CONTAINER -->   
 <div class="container min-hight">
    ...
    <div class="row-fluid margin-bottom-5">
        ...
        <?php echo count($this->session->userdata('lesen_1_soals')); ?></span> </div>
        <div class="progress">
    ...
    <div class="row-fluid margin-bottom-30">
        ...
        <div class="span9 blog-item margin-bottom-40" style="border-right: 1px solid #CFCFCF">
            ...
            <?php 
                ...
                $images = $this->session->userdata('lesen_1_images');
            ...
            <div id="result">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <img src="<?php echo base_url().$image ?>" width="450px">
                    </div>
                    <div class="controls">
                       <label style="margin:10px;"> <strong><?php echo $soal->statement; ?> </strong> </label>
 ...
 <script type="text/javascript">
    function prev_item(){
            ...
            var url = "http://localhost/master/index.php/front_end/lesenpractice_controller/prev_soal";
    ...
    function next_item(){
            ...
            var url = "http://localhost/master/index.php/front_end/lesenpractice_controller/next_soal";
            var nomor_soal = parseInt(index_soal);
            var result = $("#result"); 
    ...
    $('#soalForm').submit(function(event){
            ...
            var form = $(this); 
            var i = $("#no_soal").val();
            var url = "http://localhost/master/index.php/front_end/lesenpractice_controller/submit_teil_1";
