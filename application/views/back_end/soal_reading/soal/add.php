...
<div class="portlet box blue">
  ...
  <div class="portlet-body form">
    ...
    <!-- end form artikel -->
    <br><br>
      <form action="<?php echo base_url()?>index.php/back_end/soalreading_controller/add_soal/<?php echo $reading_text['id'] ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
      <div class="alert alert-error hide">
        <button class="close" data-dismiss="alert"></button>
        Terdapat kesalahan pada input data. Coba periksa kembali.
      </div>
