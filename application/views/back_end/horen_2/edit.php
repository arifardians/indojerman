	...
	<div class="portlet-body form">
		...
		<form action="<?php echo base_url()?>horen_2/<?php echo $horen->id; ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="statement" class=" span10 m-wrap"><?php echo $horen->statement;?></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="text" class="span10 ckeditor m-wrap"><?php echo $horen->text;?></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="span10 m-wrap" value="<?php echo base_url().$horen->sound; ?>" disabled />
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">Change Sound (max 5 Mb)<span class="required">*</span></label>
				<div class="controls">
				...
				<div class="controls">
					<select class="medium m-wrap" tabindex="1" name="value">
						<?php foreach ($options as $option):?>
							<?php if($horen->value == $option['value']): ?>
