	...
	<div class="portlet-body form">
		...
		<form action="<?php echo base_url()?>index.php/back_end/user_controller/add" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="username" class="span6 m-wrap" placeholder="username" value="<?php echo $user->username ?>" disabled>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="email" class="span6 m-wrap" placeholder="email" value="<?php echo $user->email ?>" disabled>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<select name="user_group" class="span6 m-wrap" disabled="">
			...
			<div class="form-actions">
				<a href="<?php echo base_url()?>user/<?php echo $user->id ?>" class="btn blue"><i class="fa fa-edit"></i> Edit </a>
