...
<input type="hidden" id="lesen_id" value="<?php echo $statement->lesen_1_id;?>">
...
<div class="portlet box blue">
	...
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<form action="<?php echo base_url()?>lesen_1_soal/<?php echo $statement->id;?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="statement" class="span10 m-wrap" rows="2" placeholder="input statement"><?php echo $statement->statement;?></textarea>
				</div>
			</div>
				...
				<div class="controls">
					<select class="medium m-wrap" tabindex="1" name="answer">
						<?php foreach ($options as $option):?>
							<?php if ($option['value'] == $statement->value): ?>
			...
			<div class="form-actions">
				...
				<a href="<?php echo base_url()?>lesen_1_prev/<?php echo $statement->lesen_1_id;?>" class="btn"> <i class="fa fa-mail-reply"> Cancel </i></a>
			</div>
		</form>
		<!-- END FORM-->
	</div>
