...
<div class="portlet box green">
	...
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<form action="<?php echo base_url()?>lesen_1/<?php echo $lesen->id;?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="title" class="span10 m-wrap" rows="2" placeholder="judul text soal"><?php echo $lesen->title; ?></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="span10 ckeditor m-wrap" name="text" rows="12" placeholder="teks soal"><?php echo $lesen->text; ?></textarea>
				</div>
			</div>
