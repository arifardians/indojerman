...
<div class="portlet box green">
	...
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<form action="<?php echo base_url()?>index.php/back_end/usergroup_controller/add" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="nama" placeholder="nama kategori" class="span6 m-wrap">
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="span10 ckeditor m-wrap" name="keterangan" rows="3" placeholder="keterangan kategori"></textarea>
				</div>
			</div>
