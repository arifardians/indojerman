	...
	<div class="portlet-body form">
		...
		<form action="#" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="nama" placeholder="nama kategori" class="span6 m-wrap" value="<?php echo $user_group->nama ?>" disabled>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="span10 ckeditor m-wrap" name="keterangan" rows="3" placeholder="keterangan kategori" disabled><?php echo $user_group->keterangan ?></textarea>
				</div>
			</div>

			<div class="form-actions">
				<a href="<?php echo base_url()?>user_group/<?php echo $user_group->id ?>" class="btn blue"> <i class="fa fa-edit"></i> Edit</a>
