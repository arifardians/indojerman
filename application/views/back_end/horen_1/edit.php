	...
	<div class="portlet-body form">
		...
		<form action="<?php echo base_url()?>horen_1/<?php echo $horen->id;?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="question" class="span10 ckeditor m-wrap"><?php echo $horen->question; ?></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="span6 m-wrap" value="<?php echo base_url().$horen->sound;?>" disabled />
				</div>
			</div>

			<div class="control-group">
				<label class="control-label">Replace Sound (max 5 Mb)<span class="required">*</span></label>
				<div class="controls">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="span10 ckeditor m-wrap" name="explanation"><?php echo $horen->explanation; ?></textarea>
				</div>
			</div>
