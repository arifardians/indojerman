...
<input type="hidden" id="horen_id" value="<?php echo $opsi->horen_id;?>">
...
<div class="portlet box blue">
	...
	<div class="portlet-body form">
		<br>
		<form action="<?php echo base_url()?>horen_1_opsi/<?php echo $opsi->id; ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			<div class="control-group">
				<label class="control-label">Text<span class="required">*</span></label>
				<div class="controls">
					<textarea name="text" class="span10 m-wrap" rows="2" placeholder="Input Text"><?php echo $opsi->text; ?></textarea>
				</div>
			</div>
				...
				<div class="controls">
					<div class="fileupload fileupload-new" data-provides="fileupload">
						<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
							<?php if(!empty($opsi->image)): ?>
								<img src="<?php echo base_url().$opsi->image;?>">
							<?php else: ?>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="span10 ckeditor m-wrap" name="hint"><?php echo $opsi->hint; ?></textarea>
				</div>
			</div>
				...
				<div class="controls">
					<select class="medium m-wrap" tabindex="1" name="value">
						<?php foreach ($options as $option):?>
							<?php if($opsi->value == $option['value']): ?>
			...
			<div class="form-actions">
				...
				<a href="<?php echo base_url()?>horen_1_prev/<?php echo $opsi->horen_id; ?>" class="btn"> <i class="fa fa-mail-reply"> Cancel </i></a>
			</div>
		</form>
		<!-- END FORM-->
	</div>
