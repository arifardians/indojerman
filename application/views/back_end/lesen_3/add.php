...
<div class="portlet box blue">
	...
	<div class="portlet-body form">
		<br>
		<form action="<?php echo base_url()?>lesen_3_add/" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="clue" class="span10 ckeditor m-wrap"></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="span10 ckeditor m-wrap" name="statement"></textarea>
				</div>
			</div>
