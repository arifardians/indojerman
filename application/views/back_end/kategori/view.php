		...
		<div class="portlet-body form">
			...
			<form action="#" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" disabled class="span6 m-wrap" value="<?php echo $kategori->nama ?>">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="span10 ckeditor m-wrap" disabled="" rows="3" placeholder="keterangan kategori"><?php echo $kategori->keterangan ?></textarea>
					</div>
				</div>

				<div class="form-actions">
					<a href="<?php echo base_url()?>kategori/<?php echo $kategori->id ?>" class="btn blue"><i class="fa fa-edit"></i>Edit</a>
