...
<div class="portlet box green">
	...
	<div class="portlet-body form">
		<!-- BEGIN FORM-->
		<form action="<?php echo base_url()?>lesen_2_add" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="question" class="span10 m-wrap" rows="2" placeholder="input pertanyaan"></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="explanation" class="span10 m-wrap" rows="2" placeholder="input penjelasan"></textarea>
				</div>
			</div>
