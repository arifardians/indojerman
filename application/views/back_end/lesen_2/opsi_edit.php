...
<input type="hidden" id="lesen_id" value="<?php echo $opsi->lesen_2_id;?>">
...
<div class="portlet box blue">
	...
	<div class="portlet-body form">
		<br>
		<form action="<?php echo base_url()?>lesen_2_opsi/<?php echo $opsi->id; ?>" method="post" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea name="statement" class="span10 m-wrap" rows="2" placeholder="Input Statement"><?php echo $opsi->statement;?></textarea>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="span10 ckeditor m-wrap" name="text" rows="12" placeholder="teks soal"><?php echo $opsi->text ?></textarea>
				</div>
			</div>
				...
				<div class="controls">
					<select class="medium m-wrap" tabindex="1" name="value">
						<?php foreach ($options as $option):?>
							<?php if($option['value'] == $opsi->value): ?>
...
<script src="<?php echo base_url()?>assets/scripts/back_end_header/lesen_2_load_view.js" type="text/javascript"></script>
