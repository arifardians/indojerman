...
<div class="portlet box green">
	<div class="portlet-title">
		<div class="caption"><i class="icon-globe"></i>Table list of teil 2 item</div>
	</div>
	<div class="portlet-body">
		<a href="<?php echo base_url()?>lesen_2_add" class="btn green"><i class="fa fa-plus-circle"></i> Tambah Soal</a>
		<br> &nbsp;
		<br>
